    ...
    while True:
        try:
            ...
            if "goodbye" in user_input.lower():
                ...
                yield chat_history
                return  # <-- This stops the generator and ends the Gradio event
...
def initialize_camera():
    ...
    if camera is None:
        ...
        if camera.isOpened():
            ...
            camera.set(cv2.CAP_PROP_BUFFERSIZE, 1) # Reduce buffer size to minimize latency
...
def get_webcam_frame():
    """Get the current webcam frame with optimized performance."""
...
with gr.Blocks() as demo:
    gr.Markdown("<h1 style='color: orange; text-align: center;  font-size: 4em;'> 👧🏼 Noor – Your Personal AI Assistant</h1>")
